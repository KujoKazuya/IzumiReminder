...
public class LAppLive2DManager
{
		...
		if(reloadFlg)
		{
			...
			try {
				...
				case 0:
					...
					models.get(0).load(gl, LAppDefine.MODEL_IZUMI);
					models.get(0).feedIn();
					break;
				case 1:
					releaseModel();
	...
	public boolean exprs1(){

            models.get(0).startMotion(LAppDefine.MOTION_GROUP_FLICK_HEAD,3,LAppDefine.PRIORITY_FORCE);


        return true;
    }
	public boolean exprs2(){

		models.get(0).startMotion(LAppDefine.MOTION_GROUP_FLICK_HEAD,0,LAppDefine.PRIORITY_FORCE);


		return true;
	}

	public boolean exprs3(){

		models.get(0).startMotion(LAppDefine.MOTION_GROUP_FLICK_HEAD,1,LAppDefine.PRIORITY_FORCE);
